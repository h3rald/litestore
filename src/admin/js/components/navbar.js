    ...
    controller: function (args) {
      ...
      vm.guidelinks = [{
        ...
        },
        {
          ...
          title: caret + "Use Cases"
        },
        {
          path: "/guide/architecture",
          title: caret + "Architecture"
        },
        {
          path: "/guide/data_model",
          title: caret + "Data Model"
        },
        {
        ...
        {
          path: "/guide/global-js-objects",
          title: caret + "Global JavaScript Objects"
        },
        {
          path: "/guide/system-documents",
          title: "System Documents"
        },
        {
          path: "/guide/multiple-stores",
          title: "Multiple Data Stores"
        },
        {
          path: "/guide/admin_app",
        ...
        {
          path: "/guide/api_info",
          title: caret + "info (LiteStore Information)"
        },
        {
          path: "/guide/api_dir",
          title: caret + "dir (LiteStore Directory)"
        },
        {
          path: "/guide/api_docs",
        ...
        {
          path: "/guide/api_indexes",
          title: caret + "indexes (LiteStore Indexes)"
        },
        {
          path: "/guide/api_stores",
          title: caret + "stores (LiteStore Stores)"
        },
        {
          path: "/guide/nim-api",
          title: "Nim API Reference"
        },
        {
          path: "/guide/nim-api_high",
          title: caret + "High-Level Nim API"
        },
        {
          path: "/guide/nim-api_low",
          title: caret + "Low-Level Nim API"
        },
        {
          path: "/guide/credits",
          title: "Credits"
    ...
    view: function (ctrl) {
      var links = [
        ...
        u.dropdown({
          title: "Guide",
          icon: "fa-book",
          links: ctrl.guidelinks,
          active: ctrl.activelink("guide")
        }),
        u.dropdown({
          title: "Tags",
          icon: "fa-tags",
          links: ctrl.taglinks(app.system),
          active: ctrl.activelink("tags")
        })
      ];
      if (!app.system.read_only) {
        links.push(m("li", {
          class: ctrl.activelink("new")
        }, [m("a", {
